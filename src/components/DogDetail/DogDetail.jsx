...
export default function DogDetail() {
    ...
    <img src={data.reference_image_id? `https://cdn2.thedogapi.com/images/${data.reference_image_id}.jpg` : data.name} alt=" " style={{height: 300, borderRadius: 10, border: 10}}/>
    ...
    <img src={data.image} alt="perro" style={{height: 300, borderRadius: 10, border: 10}}/>
