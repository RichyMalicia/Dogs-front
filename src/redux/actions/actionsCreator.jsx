...
export  function getAllDogs(){
    return function(dispatch){
        return  axios(`https://dogs-www.herokuapp.com/dog`)
        .then(res => {
...
export function getDogByName(name){
    return function(dispatch){
        return axios(`https://dogs-www.herokuapp.com/dog?name=${name}`)
        .then(res => {
...
export function getDogID(id){
    return function(dispatch){
        return axios(`https://dogs-www.herokuapp.com/dog/${id}`)
        .then(resp => {
...
export function getTemper(){
    return async function(dispatch){
        var temper = await axios(`https://dogs-www.herokuapp.com/temper`)
...
export function raceCreator(payload){
    return async function(dispatch){
        const newDog = await axios.post(`https://dogs-www.herokuapp.com/dog`, payload)
        return newDog
    };
};
